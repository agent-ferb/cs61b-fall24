...
public class LinkedListDeque61BTest {
    ...
    public void getRecursiveTest() {
        ...
        assertThat(lld1.getRecursive(2)).isEqualTo("Tenma");
        assertThat(lld1.getRecursive(10)).isEqualTo(null);
        assertThat(lld1.getRecursive(3)).isEqualTo("Korai");
        assertThat(lld1.getRecursive(0)).isEqualTo("Kei");
        assertThat(lld1.getRecursive(4)).isEqualTo("Tooru");
    }
